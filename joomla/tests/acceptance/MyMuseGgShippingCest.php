...
if(!$this->logged_in_front){
    ...
    $this->logged_in_front = 1;
        ...
        $I->comment("Check Shipping Quantity 2, ship method 1)");
        $I->amOnPage('index.php');
        $I->clearCart();
        $I->placeIteminCart($this->mock_order_cd);
        $I->wait(2);
        ...
        $I->comment("Check Shipping Quantity 2, ship method 2)");
        $I->amOnPage('index.php');
        $I->clearCart();
        $I->placeIteminCart($this->mock_order_cd);
        $I->wait(2);
