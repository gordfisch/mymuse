 ...
 * @since    4.0.0
 */
class MymuseCategoryListPage extends AdminListPage
{
	/**
	 ...
	 * @since  4.0.0
	 */
	public static $url = '/administrator/index.php?option=com_categories&view=categories&extension=com_mymuse';
