...
((window, document, Joomla) => {
      ...
      new Promise((resolve, reject) => {
        Joomla.request({
          ...
          onSuccess: resp => {
            ...
            const orderingSelect = document.getElementById('com-apps-ordering'); // eslint-disable-next-line no-shadow
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const initialiser = () => {
      const installerTabs = document.getElementById('myTab'); // Need to wait for the CE to have inserted the tabs list
