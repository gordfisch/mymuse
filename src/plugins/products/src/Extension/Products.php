 ...
 *
 * @copyright   (C) 2023 Arboreta Internet Services
 * @license     GNU General Public License version 2 or later; see LICENSE.txt
 */

namespace Joomla\Plugin\Finder\Products\Extension;
 ...
 * @since  2.5
 */
final class Products extends Adapter
{
    ...
    protected function index(Result $item)
    {
        ...
        $item->context = 'com_mymuse.product';

        // Initialise the item parameters.
        $registry     = new Registry($item->params);
        $item->params = clone ComponentHelper::getParams('com_mymuse', true);
        ...
        $item->route = RouteHelper::getProductRoute($item->slug, $item->catid, $item->language);
        ...
        // Translate the state. Porducts should only be published if the category is published.
        ...
        $categories = $this->getApplication()->bootComponent('com_mymuse')->getCategory(['published' => false, 'access' => false]);
