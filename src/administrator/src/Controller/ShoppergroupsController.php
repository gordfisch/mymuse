 ...
 * @since  5.0.0
 */
class ShoppergroupsController extends AdminController
{
	/**
	 * Constructor.
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'shoppergroups', $prefix = 'Administrator', $config = array('ignore_request' => true))
	{
	...
	{
		$model = $this->getModel('shoppergroups');
