...
namespace Joomla\Component\Mymuse\Administrator\View\Formats;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('MYMUSE').' : '.Text::_('COM_MYMUSE_TITLE_FORMATS'), 'formats format');

		if ($canDo->get('core.create'))
		{
			$toolbar->addNew('format.add');
		}
		...
		if ($canDo->get('core.edit.state') || $canDo->get('core.admin'))
		{
			...
			{
				$childBar->delete('formats.delete')
