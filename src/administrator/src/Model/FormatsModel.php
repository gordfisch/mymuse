...
/**
 * Methods supporting a list of format records.
 *
 * @since  5.0.0
 */
class FormatsModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__mymuse_format` AS a');
		...
		if (!empty($search)) {
			if (stripos($search, 'id:') === 0) {
                ...
                $query->where("format_key LIKE $search
                	OR format_value LIKE $search");
			}
		}
