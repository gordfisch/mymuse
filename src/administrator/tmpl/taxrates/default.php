...
{
	$saveOrderingUrl = 'index.php?option=com_mymuse&task=taxrates.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}
?>


<form action="<?php echo Route::_('index.php?option=com_mymuse&view=taxrates'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
	...
	<table class="table" id="articleList">
		<caption id="captionTable" class="sr-only">
			<?php echo Text::_('COM_MYMUSE_TAXRATES_TABLE_CAPTION'); ?>,
			...
			<tr class="row<?php echo $i % 2; ?>" >
				...
				<th scope="row">
					<div class="break-word">
						...
						<?php endif; ?>
						<?php if ($canEdit) : ?>
							<a href="<?php echo Route::_('index.php?option=com_mymuse&task=taxrate.edit&id=' . (int) $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape(addslashes($item->tax_name)); ?>">
								<?php echo $this->escape($item->tax_name); ?></a>
						<?php else : ?>
							<?php echo $this->escape($item->tax_name); ?>
						<?php endif; ?>
