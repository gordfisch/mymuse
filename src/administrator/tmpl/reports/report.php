...
HTMLHelper::_('behavior.tooltip');
		...
		<tr>
			<td width="200" class="paramlist_key"><?php echo Text::_( 'COM_MYMUSE_ORDER_STATUS' ); ?>:</td>
			<td width="100" class="paramlist_value"><?php echo $lists['order_status'];?></td>
			<td width="200" class="paramlist_key"><?php echo Text::_( 'COM_MYMUSE_START_DATE' ); ?>:</td>
			<td width="100" class="paramlist_value"><?php echo $lists['filter_date_start'];?></td>
		</tr>
		<tr>
			<td width="200" class="paramlist_key"><?php echo Text::_( 'COM_MYMUSE_SHOPPER_NAME' ); ?>:</td>
			<td width="100" class="paramlist_value"><input type="text" name="search" id="search" value="<?php echo $lists['search'];?>" class="text_area" /></td>
			<td width="200" class="paramlist_key"><?php echo Text::_( 'COM_MYMUSE_END_DATE' ); ?>:</td>
		...
		<table class="paramlist admintable">
		<tr>
			<td width="200" class="paramlist_key"><?php echo Text::_( 'COM_MYMUSE_TOTAL_ORDERS' ); ?>:</td>
	...
	<?php } ?>	
		...
		<thead>
			<tr>
				...
				<th class="title">
					<?php echo Text::_('COM_MYMUSE_NUMBER SOLD'); ?>
				</th>
				<th class="title">
