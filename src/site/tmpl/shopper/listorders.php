...
<table class="mymuse_cart">
	<thead>
	<tr>
		<th class="myorderid" width="10%"><?php echo JText::_('COM_MYMUSE_ORDER_ID'); ?></th>
		<th class="mydate" width="50%"><?php echo JText::_('COM_MYMUSE_DATE'); ?></th>
		<th class="myorderstatus" width="40%"><?php echo JText::_('COM_MYMUSE_ORDER_STATUS'); ?></th>
		<th class="mytotal" width="40%" align="right"><?php echo JText::_('COM_MYMUSE_ORDER_TOTAL'); ?></th>
	...
	<tr>
		...
		<td class="myorderstatus"><?php echo JText::_('COM_MYMUSE_'.strtoupper(MyMuseHelper::getStatusName($order->order_status))) ?></td>
