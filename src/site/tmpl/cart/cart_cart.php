		...
		<?php
		  ...
		  for ($i=0;$i<count($order_item); $i++) { ?>
		   ...
		   <?php if($order->do_html && $order_item[$i]->quantity){ ?>
		        <td class="myquantity cart"> <input class="inputbox" type="text" size="4" maxlength="4" name="quantity[<?php echo $order_item[$i]->id ?>]" id="quantity<?php echo $order_item[$i]->id ?>"
