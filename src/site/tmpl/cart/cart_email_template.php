...
$download_header .= '
	...
	$download_header .= '
	<table style="border-collapse: collapse; width: 800px;" class="mymuse-cart cart">
		<tr>
...
<title><?php echo $store->title; ?></title>
    ...
    <table width="100%" class="mymuse-cart my-email-header" 
    style="border-collapse: collapse; width: 800px;">
    	<tr >
        	<td width="30%" class="my-email-header" valign="top" rowspan="8"><a href="'.JURI::root().'"><img 
        style="padding:0 20px 20px 0" src="<?php echo JURI::root().$params->get('store_thumb_image'); ?>" border="0"></a></td>
  		</tr>

        <tr><td width="80%" class="my-email-header mytitle"><?php echo $store->title; ?></td></tr>
...
<?php 
	//any message generated by plugins
	echo $this->my_email_msg; ?>
<?php
...
<!-- Begin Order Summary -->
	<h3 style="text-decoration: underline;" class="my-title"><?php echo Text::_('COM_MYMUSE_ORDER_SUMMARY'); ?></h3>
     <table class="mymuse-cart" style="border-collapse: collapse; width: 800px;">
        <tr>
   ...
   <!-- Begin Bill To -->
        ...
        <div class="shopper">
            <table class="mymuse-cart" style="border-collapse: collapse; width: 800px;">
                <tr class="mymuse-cart_top">
                <td class="mymuse-cart_top" COLSPAN="2"><b><?php echo Text::_('COM_MYMUSE_BILLING_ADDRESS') ?></b></td>
                </tr>
                <tr>
        ...
        <div class="shopper">
            <table class="mymuse-cart" style="border-collapse: collapse; width: 800px;">
                <tr class="mymuse-cart_top">
                <th class="mymuse-cart_top" COLSPAN="2"><b><?php echo Text::_('COM_MYMUSE_SHIPPING_ADDRESS') ?></b></th>
                </tr>
                <tr>
		...
		<table class="mymuse-cart" style="border-collapse: collapse; width: 800px;">
			<tr class="mymuse-cart_top">
				<th class="mymuse-cart_top" align="left"width="55%"><b><?php echo Text::_('COM_MYMUSE_TITLE'); ?></b></th>
				<th class="mymuse-cart_top" align="right" width="15%"><b><?php echo Text::_('COM_MYMUSE_CART_PRICE'); ?></b></th>
				<th class="mymuse-cart_top" align="right" width="15%"><b><?php echo Text::_('COM_MYMUSE_CART_QUANTITY'); ?></b></th>
				<th class="mymuse-cart_top" align="right" width="15%"><b><?php echo Text::_('COM_MYMUSE_CART_SUBTOTAL'); ?></b></th>
			</tr>
