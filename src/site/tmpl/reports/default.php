<?php
/**
 * @version	 $Id: default.php 1297 2014-06-11 18:09:24Z gfisch $
 * @package     com_mymuse3
...
?>
		...
		<h2><?php echo Text::_('JGLOBAL_FILTER_BUTTON'); ?></h2>
		...
		<tr>
			...
			<button onclick="this.form.submit();"><?php echo Text::_( 'COM_MYMUSE_CREATE_REPORT' ); ?></button>
			</td>
		</table>
...
if($orders_total >0 && count( $rows )){ ?>
		...
		<?php echo Text::_('COM_MYMUSE_ORDER_SUMMARY_EXPLANATION'); ?>
		<table class="mymuse_cart">
		<tr>
			<td width="200"><?php echo Text::_( 'COM_MYMUSE_TOTAL_NO_ORDERS' ); ?>:</td>
			<td width="100" align="right"><?php echo $orders_total; ?></td>
		</tr>
		<tr>
			<td width="200"><?php echo Text::_( 'COM_MYMUSE_TOTAL_SUBTOTAL' ); ?>:</td>
			<td width="100" align="right"><?php echo MyMuseHelper::printMoney($orders_summary->total_subtotal); ?></td>
		</tr>
		<tr>
			<td width="200"><?php echo Text::_( 'COM_MYMUSE_TOTAL_SHIPPING' ); ?>:</td>
			<td width="100" align="right"><?php echo MyMuseHelper::printMoney($orders_summary->total_shipping); ?></td>
		</tr>
		<tr>
			<td width="200"><?php echo Text::_( 'COM_MYMUSE_TOTAL_DISCOUNTS' ); ?>:</td>
...
<?php if(count( $rows )){ ?>
		...
		<thead>
			<tr>
				<th class="title">
					<?php echo Text::_('COM_MYMUSE_PRODUCT'); ?>
				</th>
				<th class="title">
				...
				<th class="title">
					<?php echo Text::_( 'COM_MYMUSE_TOTAL_ARTIST' ); ?>
				</th>
			</tr>
		</thead>
		...
		?>
			<tr>
				<td colspan="3" align="right"><?php echo Text::_('COM_MYMUSE_TOTAL'); ?></td>
